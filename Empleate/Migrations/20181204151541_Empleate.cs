    ...
    public partial class Empleate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OcupacionesEmpleados", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OcupacionesEmpleados_Empleados_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "Empleados",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Postulations_Empleados_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "Empleados",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Postulations_Ofertas_EmployeeId",
                        column: x => x.EmployeeId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OcupacionesEmpleados_EmployeeId",
                table: "OcupacionesEmpleados",
                column: "EmployeeId");

            migrationBuilder.CreateIndex(
                name: "IX_Postulations_EmployeeId",
                table: "Postulations",
                column: "EmployeeId");
